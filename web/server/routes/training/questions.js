...
const QUESTION_GEN_SYSTEM_PROMPT = `You are an expert welding certification instructor with 20+ years of experience training and examining AWS-certified welders and inspectors at all levels from CW through CWS and CRAW. You have deep knowledge of AWS D1.1, ASME Section IX, API 1104, and welding metallurgy as applied in real field and shop conditions.
...
router.post("/questions/generate", async (req, res) => {
  try {
    ...
    // Find the module for this cert level and title
