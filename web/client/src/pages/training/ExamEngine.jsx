        ...
        return (
          <button
            ...
            style={{
              ...
              backgroundColor: bg,
              border: i === current ? `2px solid ${ACCENT}` : '1px solid #3A3A3E',
              cursor: 'pointer',
      ...
      <div className="card">
        ...
        <div className="stack-sm">
          {(q.options || []).map((opt) => {
            ...
            if (isRevealed) {
              if (isCorrect) { bg = 'rgba(249,115,22,0.1)'; border = ACCENT; }
          ...
          <>
            {q.explanation && (
              <div style={{
                ...
                backgroundColor: 'rgba(249,115,22,0.05)', borderRadius: 8,
