        ...
        <div className="stack-sm">
            ...
            <div key={item.id} style={{
              ...
              <div style={{ flex: 1 }}>
                <p style={{ fontSize: '0.875rem', fontWeight: 500 }}>
                  {item.weld_process || 'Weld analysis'} — {item.files?.length || 0} photo{item.files?.length !== 1 ? 's' : ''}
                </p>
          ...
          {failed.map(item => (
            <div key={item.id} style={{
              ...
              <div style={{ flex: 1 }}>
                <p style={{ fontSize: '0.875rem', fontWeight: 500 }}>
                  {item.weld_process || 'Weld analysis'}
                </p>
              ...
              <div className="row" style={{ gap: 4 }}>
                <button
                  className="btn btn-ghost"
                  style={{ padding: '4px 8px', minHeight: 'auto', fontSize: '0.75rem', color: '#F97316' }}
